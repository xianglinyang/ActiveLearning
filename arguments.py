...
def get_arguments():
    ...
    parser.add_argument("--resume_path", default="/home/xianglin/projects/DVI_data/active_learning/base/resnet18/CIFAR10/Model/Iteration_1/", type=str, help="path to where ckpt is saved")
